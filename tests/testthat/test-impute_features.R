...
expect_equal(mean(abs(x$Sepal.Width - imputed_x$Sepal.Width)), 0.0772336783986305)
...
expect_equal(sum(imputed_x$Species != x$Species), 34)
expect_equal(mean(abs(x$Sepal.Width - imputed_x$Sepal.Width)), 0.231564627359759)
